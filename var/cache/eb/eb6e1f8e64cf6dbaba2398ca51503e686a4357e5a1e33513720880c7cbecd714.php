...
/* partials.html */
class __TwigTemplate_204ed601634c3c71c82f00ee33c582682df724db13d71ac1cb416f45542d1b39 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("layout.html", "partials.html", 1);
...
\t\t\t\t\t            <th scope=\"col\" class=\"align-middle\" style=\"border-right: 1px solid black\"> # </th>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                echo "\"> 
                                                <table class=\"table table-bordered\">
                                                    <tbody style=\"text-align: center\">
                                                        <tr>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Energia caricata [MWh] </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 117
                ...
                echo " </td>  
                                                            <th class=\"bg-success bg-gradient align-middle\"> Quantità nominale caricata [kg] </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 119
                ...
                echo " </td>   
                                                            <th class=\"bg-success bg-gradient align-middle\"> Raffreddamento </th>            
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 121
                ...
                echo " </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Tipologia costo extra </th>            
                                                            <td class=\"bg-gradient align-middle\"> ";
                // line 123
                ...
                echo " </td>          
                                                        ...
                                                        <tr>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Valore costo extra </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 128
                ...
                echo " </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Quantità scaricata PD [kg] </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 130
                ...
                echo " </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Densità (liquido) [<sup>kg</sup>&frasl;<sub>m<sup>3</sup></sub>] </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 132
                ...
                echo " </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Peso specifico (gas) <big>[</big><sup>kg</sup>&frasl;<sub>Nm<sup>3</sup></sub><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\"> ";
                // line 134
                ...
                echo " </td>
                                                        ...
                                                        <tr>
                                                            <th class=\"bg-success bg-gradient align-middle\"> PCS/GHV <big>[</big><sup>MJ</sup>&frasl;<sub>kg</sub><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 139
                ...
                echo " </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> PCS/GHV <big>[</big><sup>kWh</sup>&frasl;<sub>kg</sub><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 141
                ...
                echo " </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Volume scaricato (liquido) <big>[</big>m<sup>3</sup><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 143
                ...
                echo " </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Volume sviluppato <big>[</big><sup>Nm<sup>3</sup></sup>&frasl;<sub>m<sup>3</sup></sub><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\"> ";
                // line 145
                ...
                echo " </td> 
                                                        ...
                                                        <tr>
                                                            <th class=\"bg-success bg-gradient align-middle\"> <sup>Sm<sup>3</sup></sup>&frasl;&nbsp;<sub>m<sup>3</sup></sub> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 150
                ...
                echo " </td>   
                                                            <th class=\"bg-success bg-gradient align-middle\"> Gas sviluppato <big>[</big>Nm<sup>3</sup><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 152
                ...
                echo " </td>   
                                                            <th class=\"bg-success bg-gradient align-middle\"> Gas sviluppato <big>[</big>Sm<sup>3</sup></sup><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> ";
                // line 154
                ...
                echo " </td>   
                                                            <th class=\"bg-success bg-gradient align-middle\"> <sup>Sm<sup>3</sup></sup>&frasl;&nbsp;<sub>kg</sub> </th>
                                                            <td class=\"bg-gradient align-middle\"> ";
                // line 156
                            ...
                            <tr>
                                <td colspan=\"16\" class=\"text-light align-middle\">
                                    <h5 style=\"font-weight: 600\" class=\"align-middle\">
                                        TOTALE <i class=\"bi bi-fuel-pump ms-1\"></i>:
                                            <span> 
                                                ";
        // line 173
                                            ...
                                            <div class=\"accordian-body collapse rowQty\" id=\"q-{{ quantities[i].id_transport }}\"> 
                                                <table class=\"table table-bordered\">
                                                    <tbody style=\"text-align: center\">
                                                        <tr>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Energia caricata [MWh] </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].mwh }} </td>  
                                                            <th class=\"bg-success bg-gradient align-middle\"> Quantità nominale caricata [kg] </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].kg_load }} </td>   
                                                            <th class=\"bg-success bg-gradient align-middle\"> Raffreddamento </th>            
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].cooling }} </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Tipologia costo extra </th>            
                                                            <td class=\"bg-gradient align-middle\"> {{ quantities[i].price_typology }} </td>          
                                                        </tr>
                                                    
                                                        <tr>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Valore costo extra </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].price_value }} </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Quantità scaricata PD [kg] </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].kg_unload }} </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Densità (liquido) [<sup>kg</sup>&frasl;<sub>m<sup>3</sup></sub>] </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].liquid_density }} </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Peso specifico (gas) <big>[</big><sup>kg</sup>&frasl;<sub>Nm<sup>3</sup></sub><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\"> {{ quantities[i].gas_weight }} </td>
                                                        </tr>
                                                    
                                                        <tr>
                                                            <th class=\"bg-success bg-gradient align-middle\"> PCS/GHV <big>[</big><sup>MJ</sup>&frasl;<sub>kg</sub><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].mj_kg }} </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> PCS/GHV <big>[</big><sup>kWh</sup>&frasl;<sub>kg</sub><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].pcs_ghv }} </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Volume scaricato (liquido) <big>[</big>m<sup>3</sup><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].volume_mc }} </td>
                                                            <th class=\"bg-success bg-gradient align-middle\"> Volume sviluppato <big>[</big><sup>Nm<sup>3</sup></sup>&frasl;<sub>m<sup>3</sup></sub><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\"> {{ quantities[i].volume_nmc }} </td> 
                                                        </tr>
                                                    
                                                        <tr>
                                                            <th class=\"bg-success bg-gradient align-middle\"> <sup>Sm<sup>3</sup></sup>&frasl;&nbsp;<sub>m<sup>3</sup></sub> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].smc_mc }} </td>   
                                                            <th class=\"bg-success bg-gradient align-middle\"> Gas sviluppato <big>[</big>Nm<sup>3</sup><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].gas_nmc }} </td>   
                                                            <th class=\"bg-success bg-gradient align-middle\"> Gas sviluppato <big>[</big>Sm<sup>3</sup></sup><big>]</big> </th>
                                                            <td class=\"bg-gradient align-middle\" style=\"border-right: 4px double white\"> {{ quantities[i].gas_smc }} </td>   
                                                            <th class=\"bg-success bg-gradient align-middle\"> <sup>Sm<sup>3</sup></sup>&frasl;&nbsp;<sub>kg</sub> </th>
                                                            <td class=\"bg-gradient align-middle\"> {{ quantities[i].smc_kg }} </td>            
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div> 
...
{% endblock %}", "partials.html", "D:\\wamp\\www\\liquimet\\templates\\partials.html");
    }
}
