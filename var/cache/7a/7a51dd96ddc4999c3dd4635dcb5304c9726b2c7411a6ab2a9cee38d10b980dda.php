...
/* index.html */
class __TwigTemplate_5b86787e1795350d1ea2341ebe992e4889c3360eccd1dcf18c3d36a3e43bbc58 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        <div class=\"pagetitle\">
            <h1 class=\"mx-auto my-1 py-1\"> 
                ";
        // line 8
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "gender", [], "any", false, false, false, 8), "m"))) {
            // line 9
            echo "                    Benvenuto 
                ";
        } else {
        ...
        echo "!
                ...
                <nav style=\"--bs-breadcrumb-divider: none\" aria-label=\"breadcrumb\" style=\"text-align: center\">
                    <ol class=\"breadcrumb p-2 mx-auto mt-3\" style=\"border: 1px solid white; border-radius: 5px; width: 18%; text-align: center\">        
                        ...
                        <div class=\"col-lg-12 py-0 mx-auto\">
                            <div class=\"card info-card profile-card mb-3\">
                                <div class=\"card-body\">
                                    ...
                                    ";
        // line 192
        if (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "id_user", [], "any", false, false, false, 192)) {
            // line 193
...
-->
{% endblock %}", "index.html", "C:\\wamp\\www\\liquimet\\templates\\index.html");
    }
}
